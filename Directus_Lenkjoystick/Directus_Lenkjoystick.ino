// =============================================================================
// GripSwitch – Directus + Lenkjoystick
// =============================================================================
// Griff:    Directus (16 Tasten via MCP23017, Thumbstick auf A0/A1)
// Unterbau: Lenkjoystick (1x AS5600, Rz-Achse)
...
// Index = HID-Button (0-basiert), Wert = MCP23017-Pin
// Taste 1-8  → GPA0-GPA7 (MCP Pin 0-7)
// Taste 9    → GPB7 (MCP Pin 15)
// Taste 10   → GPB1 (MCP Pin 9)
// Taste 11   → GPB0 (MCP Pin 8)
// Taste 12   → GPB2 (MCP Pin 10)
// Taste 13   → GPB3 (MCP Pin 11)
// Taste 14   → GPB4 (MCP Pin 12)
// Taste 15   → GPB5 (MCP Pin 13)
// Taste 16   → GPB6 (MCP Pin 14) = 12-mm-Taster
// =============================================================================
...
// Taste 15 (MCP Pin 13) + Taste 16 / 12-mm-Taster (MCP Pin 14)
// =============================================================================
...
// 16 physische Buttons + 1 Kalibrierungs-Indikator (virtuell)
// =============================================================================
#define HID_BUTTON_COUNT  17
#define CAL_INDICATOR_BTN 16   // 0-basierter Index
...
#define CAL_ACTIVATE_MS   10000  // 10 Sek. halten zum Aktivieren
#define CAL_CENTER_MS      5000  //  5 Sek. Mittelposition ermitteln
#define CAL_STOP_MS        5000  //  5 Sek. halten zum Beenden
...
Joystick_ Joystick(
  ...
  false, false, true, // Rx, Ry, Rz (AS5600 Lenkachse)
...
// =============================================================================
// Kalibrierungs-Indikator blinken
// =============================================================================
...
// =============================================================================
// MCP23017-Buttons lesen und an HID senden
// =============================================================================
void readMCPButtons() {
  for (int i = 0; i < 16; i++) {
...
// =============================================================================
// Kalibrierungsmodus (AS5600 Lenkachse)
//
// Blinkmuster:
//   Schnell (200ms)     = 2-Sek. Wartezeit nach Loslassen der Tasten
//   Langsam (500ms)     = Phase 1: Griff neutral halten
//   Dauerhaft AN        = Phase 2: Griff frei bewegen
...
void setup() {
  ...
  Joystick.setRzAxisRange(-32767, 32767); // Lenkachse (AS5600)
...
// =============================================================================
void loop() {
  // Kalibrierung jederzeit aktivierbar (10 Sek. halten)
  ...
  Joystick.setRzAxis((int)axis);

  // Kalibrierungs-Indikator aus im Normalbetrieb
  Joystick.setButton(CAL_INDICATOR_BTN, 0);
